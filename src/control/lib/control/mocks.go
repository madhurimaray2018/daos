...
func (mi *MockInvoker) Debug(msg string) {
	mi.cfg.log.Debug(msg)
}

func (mi *MockInvoker) Debugf(fmtStr string, args ...interface{}) {
	mi.cfg.log.Debugf(fmtStr, args...)
}

func (mi *MockInvoker) InvokeUnaryRPC(_ context.Context, _ UnaryRequest) (*UnaryResponse, error) {
...
func NewMockInvoker(cfg *MockInvokerConfig) *MockInvoker {
	if cfg == nil {
...
func DefaultMockInvoker() *MockInvoker {
	return NewMockInvoker(nil)
}
